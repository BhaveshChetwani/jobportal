...
<script src="/jobportal/js/updatecandidate.js?reload=<%=reload %>" type="text/javascript"></script>
...
<div class="d-inline-block col-3 pt-1">	
	<input type="text" name="id" id="id" value="${candidate.id }" />
		<table>
			...
			<tr>
				<td>
					<input type="Submit" class="btn btn-success" value="Update Candidate" onclick="saveCandidate();"/>
				</td>
			</tr>

		</table>
		<input type="text" name="documentUuid" id="documentUuid" value="${document.uuid}" />
		<input type="text" name="documentName" id="documentName" value="${document.documentName}" />
		</div>
		<div class="d-inline-block col-6 pt-2" id="docUploadSection">
		<table>
		<tr>
			<td>
				<input type="file" id="mydoc" />
			</td>
		</tr>
		<tr>
			<td>
